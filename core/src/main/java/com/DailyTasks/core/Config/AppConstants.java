...
public final class AppConstants {
    ...
    public static final String SUB_SERVICE = "abhi";
    ...
    public static final String COUNTRY_LIST_PATH = "/content/dam/DailyTasks/country.json";
    public static final String COLOR_LIST = "colorList";
    public static final String COLOR_LIST_PATH = "/content/dam/DailyTasks/color.json";
    public static final String FONT_LIST = "fontList";
    public static final String FONT_LIST_PATH = "/content/dam/DailyTasks/font.json";
    // Image List
    // public static final String IMAGE_LIST = "imageList";
    // public static final String IMAGE_LIST_PATH = "/content/dam/DailyTasks/imageList.json";
